...
cc_data  = rodar_radon(["radon", "cc",  "./imbens", "-j"])
print("Rodando radon mi...")
mi_data  = rodar_radon(["radon", "mi",  "./imbens", "-j"])
print("Rodando radon hal...")
hal_data = rodar_radon(["radon", "hal", "./imbens", "-j"])
print("Rodando radon raw...")
raw_data = rodar_radon(["radon", "raw", "./imbens", "-j"])
